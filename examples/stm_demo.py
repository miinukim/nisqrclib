...
def main():
    ...
    stm_cfg = STMConfig(T_total=400, washout=50, train_len=200, test_len=100,
    ...
    eres = run_stm_esn(T_total=stm_cfg.T_total, washout=stm_cfg.washout,
                       ...
                       esn_cfg=esn_cfg, metric=stm_cfg.metric)
    mc_e = runner.memory_capacity(eres, use_test=True)

    print("Quantum MC:", mc_q)
    print("ESN MC:", mc_e)
